 ...
 */
class Umzug extends _events.EventEmitter {
  /**
  ...
  execute(options = {}) {
    ...
    return _bluebird2.default.map(options.migrations, migration => {
      if (typeof migration === "string") {
        return self._findMigration(migration);
      } else if (migration instanceof _migration3.default) {
        return self._findMigration(migration.file);
      } else {
        throw Error("You must pass a file name or Migration instance in options.migration");
      }
    }).then(migrations => (0, _extends3.default)({}, options, {
      migrations
...
Umzug.Migration = _migration3.default;
